#!/usr/bin/env python3
"""
Install dependencies and download AtomicCards.json.
Run via: python -m src.lib.setup --install | --download [--force]
...
def do_install() -> None:
    """Install runtime dependencies from the project requirements file."""
